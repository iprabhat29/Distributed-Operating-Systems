...
def Main():
    ...
    print "connected!!"
    add_msg = "/registerClient/Prabhat/Stone Curling/5051"			#ClientID = Apoorva ; EventType = Stone Curling ; Port = 5050
    ...
    delobj.killClient("Prabhat",5051)
    s.close()
